...
void WriteFloatGridNpy(std::string _file, int3 _grid_dim, openvdb::FloatGrid::Ptr _float_grid)
{
    std::vector<float> data;
    data.resize(_grid_dim.x * _grid_dim.y * _grid_dim.z);
    auto axr{ _float_grid->getConstUnsafeAccessor() };
